...
describe(`DELETE ${ENDPOINT} (User Deletion)`, () => {
  ...
  RewiredAuthorization.deleteAuthorization = async () => undefined;
  ...
  RewiredUserDatabaseHandle.prototype.deleteUser = async () => undefined;
  ...
  RewiredReportDatabaseHandle.prototype.deleteUserReports = async () => undefined;

  // Rewire file storage
  RewiredFileStorage.deleteImagesByTokens = async () => undefined;
  ...
  after(() => {
    rewiremock.disable();
    console.log(
      require('../../src/core/authorization').authorizeUser(
        mockUser,
        mockAccessToken
      )
    );
